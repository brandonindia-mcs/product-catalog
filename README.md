...
This requires an explanation.  In the 12 hours post this screenshot, my Azure credits expired so access to the LLM backend is revoked. 
...
Demonstrates prompt into a React chat component that triggeres a canned prompt to be sent to Azure OpenAI. The reply from the LLM backend was captured and displayed in realtime.
